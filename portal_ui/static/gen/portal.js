...
else{$hidden.val('no');}}); $('#bounding-box input').change(function(){$(APP.DOM.form).find('input[name=bBox]').val(APP.DOM.getBBox());}); $('#show-queries-button').click(function(){
...
PORTAL.MODELS.help={country:{placement:'auto',title:'Country Help',content:'\
        ...
        be selected. </div>'},assemblage:{placement:'auto',title:'Assemblage Help',content:'\
    		<div>The Assemblage is specific to biological collection data, and refers to "An association \
    		of interacting populations of organisms in a given waterbody."  For example, macroinvertabrates or fish/necton  </div>'},pcode:{placement:'auto',title:'Parameter Code Help',content:'\

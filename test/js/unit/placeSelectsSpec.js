describe('Test PORTAL.VIEWS.createPlaceSelects', function() {
    var placeSelects;
    
    beforeEach(function() {
       var countryHtml = '<input name="countrycode" id="country-select" type="hidden" />';
       var stateHtml = '<input name="statecode" id="state-select" type="hidden" />';
       var countyHtml = '<input name="countycode" id="county-select" type="hidden" />';
    ...
    it('Expects placeSelects.getCountries to reflect the current countries set', function() {
        ...
        $('#country-select').select2('data', [{id : 'US'}, {id : 'CN'}]);
